...
namespace digitalmaktabapi.Migrations
{
    ...
    [Migration("20240811234320_TeacherClassRelathionshipchanged")]
    partial class TeacherClassRelathionshipchanged
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("digitalmaktabapi.Models.Class", b =>
                {
                    ...
                    b.HasOne("digitalmaktabapi.Models.Teacher", "Teacher")
                        .WithOne("Class")
                        .HasForeignKey("digitalmaktabapi.Models.Class", "TeacherId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
